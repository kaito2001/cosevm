...
import (
	...
	cosevmmodule "cosevm/x/cosevm"
	cosevmmodulekeeper "cosevm/x/cosevm/keeper"
	cosevmmoduletypes "cosevm/x/cosevm/types"
...
type App struct {
	*baseapp.BaseApp
	...
	CosevmKeeper cosevmmodulekeeper.Keeper
...
func New(
	...
	app.CosevmKeeper = *cosevmmodulekeeper.NewKeeper(
		appCodec,
		keys[cosevmmoduletypes.StoreKey],
		keys[cosevmmoduletypes.MemStoreKey],
		app.GetSubspace(cosevmmoduletypes.ModuleName),
	)
	cosevmModule := cosevmmodule.NewAppModule(appCodec, app.CosevmKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(cosevmmoduletypes.ModuleName)
